...
public class AuthorController {
    ...
    @PostMapping
    public AuthorDTO create(@Valid @RequestBody AuthorDTO authorDTO) { return authorService.createAuthor(authorDTO); }

    @GetMapping("/{id}")
    public AuthorDTO get(@PathVariable Long id) { return authorService.getAuthorById(id); }
    ...
    @DeleteMapping("/{id}")
    public void delete(@PathVariable Long id) { authorService.deleteAuthor(id); }

    @GetMapping
    public List<AuthorDTO> list() { return authorService.getAllAuthors(); }

    @GetMapping("/{id}/books")
    public Set<BookDTO> booksByAuthor(@PathVariable Long id) {
