...
public class BookController {
    ...
    @PostMapping
    public BookDTO create(@Valid @RequestBody BookDTO bookDTO) { return bookService.createBook(bookDTO); }

    @GetMapping("/{isbn}")
    public BookDTO get(@PathVariable String isbn) { return bookService.getBookByIsbn(isbn); }
    ...
    @DeleteMapping("/{isbn}")
    public void delete(@PathVariable String isbn) { bookService.deleteBook(isbn); }

    @GetMapping
    public List<BookDTO> list() { return bookService.getAllBooks(); }
